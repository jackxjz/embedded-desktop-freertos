...
#### Added
- New system Settings application with dedicated settings page launched from desktop icon
- Implement cursor size adjustment with multi-level real-time preview and instant apply
- Persist all settings to NVS to maintain user configuration across reboots

#### Improved
- Refactor system parameter management with unified NVS read/write API for all modules
- Optimize desktop app launch flow with application-level navigation and back-stack management
